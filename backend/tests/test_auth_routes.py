...
def test_profile_includes_stats_and_activity(client, auth_headers, app_ctx, user):
    ...
    tc1 = TestCase(problem_id=p1.id, serial_number=0, test_input={"args": []}, expected_output="1", is_active=True)
    tc2 = TestCase(problem_id=p2.id, serial_number=0, test_input={"args": []}, expected_output="1", is_active=True)
